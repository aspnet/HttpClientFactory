...
namespace Microsoft.Extensions.Http
{
    ...
    internal class DefaultHttpMessageHandlerBuilderPostInitializer : IHttpMessageHandlerBuilderPostInitializer
    {
        private readonly ILoggerFactory _loggerFactory;

        public DefaultHttpMessageHandlerBuilderPostInitializer(ILoggerFactory loggerFactory)
        {
        ...
        public void Apply(HttpMessageHandlerBuilder builder)
        {
            if (builder == null)
            {
